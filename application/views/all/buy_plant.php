...
<head>
    <meta charset="UTF-8">  
    <title>MEMBELI PANDUAN TANAMAN</title>
...
<body>
    ...
    <h2>Tanaman, Panduan, dan Item Terkait Tanaman Lainnya </h2>
    <div class="bdr123">
        <div class="border"> 
            <figcaption>
                PEDULI UNTUK PEMULA 
                <figure>
                    <img src="<?php echo base_url()?>assets/img/image37.png">
                    10 Cara-cara penting untuk<br>
                    meningkatkan kelembaban di<br>
                    Rumah Anda<p>
                <button class = "btn">Beli Hanya  Rp 5000;</button>
            </figcaption></figure>
        </div>
        <div class="border">
            <figcaption>
                PEDULI UNTUK PEMULA
                <figure>
                    <img src="<?php echo base_url()?>assets/img/image28.png">
        ...
        <div class="border">
            <figcaption>
                PEDULI UNTUK PEMULA
                <figure>
                    <img src="<?php echo base_url()?>assets/img/image29.png">
                    Bagaimana cara<br>
                    menanam<br>
                    tanaman cabai?<p>
                <button class = "btn">Beli Hanya  Rp 8000;</button>
            </figcaption></figure>
        </div>
    </div>
    <div class="bdr123">
        <div class="border">
            <figcaption>
                PEDULI UNTUK PEMULA
                <figure>
                    <img src="<?php echo base_url()?>assets/img/image44.png">
                    Di mana Anda bisa<br>
                    mendapatkan inspirasi<br> 
                    desain taman?<p>
                <button class = "btn">Beli Hanya Rp 15000;</button>
            </figcaption></figure>
        </div>
        <div class="border">
            <figcaption>
                PEDULI UNTUK PEMULA
                <figure>
                    <img src="<?php echo base_url()?>assets/img/image42.png">
                    Pohon  - Menyiram<br>
                    dan <br>
                    perawatan musim dingin<p>
                <button class = "btn">Beli Hanya  Rp 10000;</button>
            </figcaption></figure>
        </div>
        <div class="border">
            <figcaption>
                PEDULI UNTUK PEMULA
                <figure>
                    <img src="<?php echo base_url()?>assets/img/image46.png">
                    Bagaimana cara<br> 
                    memulai<br> 
                    kebun sayur?<p>
                <button class = "btn">Beli Hanya  Rp 10000;</button>
