        ...
        <div class="border"> 
            <figcaption>
                ...
                <figure>
                    ...
                    your house<p>
                <button class = "btn">Buy Only  Rp 5000;</button>
            </figcaption></figure>
        </div>
        <div class="border">
            <figcaption>
        ...
        <div class="border">
            <figcaption>
                ...
                <figure>
                    ...
                    grow chili<br>
                    plants?<p>
                <button class = "btn">Buy Only  Rp 8000;</button>
            </figcaption></figure>
        </div>
    </div>
    <div class="bdr123">
        <div class="border">
            <figcaption>
                ...
                <button class = "btn">Buy Only  Rp 15000;</button>
            </figcaption></figure>
        </div>
        <div class="border">
            <figcaption>
                ...
                <figure>
                    ...
                    and <br>
                    winter care<p>
                <button class = "btn">Buy Only  Rp 10000;</button>
            </figcaption></figure>
        </div>
        <div class="border">
            <figcaption>
